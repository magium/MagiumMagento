...
namespace Magium\Magento\Themes\MagentoEE113\OnePageCheckout;
...
class ThemeConfiguration extends AbstractThemeConfiguration
{
    ...
    protected $customerButtonXpath          = '//form[@id="login-form"]/descendant::button[@onclick="loginForm.submit()"]';
...
//    protected $billingRegionIdXpath       = null; // Apparently this is not needed for 1.8
    ...
    protected $billingContinueButtonXpath = '//div[@id="billing-buttons-container"]/descendant::button[@onclick="billing.save()"]';
...
//    protected $shippingRegionIdXpath       = null; // Magento 1.8's checkout apparently does not have this
    ...
    protected $shippingContinueButtonXpath = '//div[@id="shipping-buttons-container"]/descendant::button[@onclick="shipping.save()"]';
