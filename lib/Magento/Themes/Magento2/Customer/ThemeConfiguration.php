...
namespace Magium\Magento\Themes\Magento2\Customer;
...
class ThemeConfiguration extends AbstractThemeConfiguration
{
    ...
    protected $accountNavigationXpath   = '//div[@id="block-collapsible-nav"]/descendant::a[.="%s"]';
    protected $accountSectionHeaderXpath = '//div[contains(concat(" ",normalize-space(@class)," ")," main ")]/descendant::h1[@class="page-title"]/span[.="%s"]';
