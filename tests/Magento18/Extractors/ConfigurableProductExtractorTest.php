...
class ConfigurableProductExtractorTest extends AbstractMagentoTestCase
{
    ...
    public function testExtractConfigurableProducts()
    {
        ...
        self::assertInstanceOf('Magium\Magento\Extractors\Catalog\Product\Value', $optionValue);
        self::assertNotInstanceOf('Magium\Magento\Extractors\Catalog\Product\SwatchValue', $optionValue);
